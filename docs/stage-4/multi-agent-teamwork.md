...
起点是一段大白话："我要做一个 2026 世界杯赛事 Web 应用，需要展示 48 支球队、104 场赛程与实时比分……"接活的是 **Claude Code**：Anthropic 公司出的编程 Agent。Agent（智能体）这个词在[什么是 Agentic AI](/stage-3/agentic-ai) 里讲过，简单说就是**能自己拆解任务、自己调用工具、连续干活的 AI**，跟一问一答的聊天机器人不是一回事。
