---
title: 2026-08-05 · AI 日报
description: 2026-08-05 AI 行业精选（数据来自 AIHOT）
date: 2026-08-05
---
...
[阅读原文 →](https://blogs.nvidia.com/blog/alpamayo-2-super-open-model-now-available) · 来源：NVIDIA Blog
...
[阅读原文 →](https://x.com/SenseTime_AI/status/2084667189479837741) · 来源：X：商汤 SenseTime (@SenseTime_AI)
...
[阅读原文 →](https://x.com/OpenRouter/status/2084699413898027064) · 来源：X：OpenRouter (@OpenRouter)

### 4. 蚂蚁百灵发布Ling-3.0-flash开源权重

今天，我们发布了 Ling-3.0-flash 的开源权重。🎉 官方 BF16 和 FP8 量化版本现已可用，您可以根据自己的硬件、性能要求和部署需求选择最合适的版本。

[阅读原文 →](https://x.com/AntLingAGI/status/2084656533489754475) · 来源：X：蚂蚁百灵 (@AntLingAGI)
...
[阅读原文 →](https://mp.weixin.qq.com/s?__biz=MzkwODU2OTQyNQ%3D%3D&mid=2247498223&idx=1&sn=ae271ec2c72723393d3e1d8074a33205) · 来源：公众号：腾讯混元

### 6. FLUX 3 Video, Part 1: Generation FLUX 3 Video, Part 1 August 4, 2026 Read more

[阅读原文 →](https://bfl.ai/blog/flux-3-video) · 来源：Black Forest Labs：Blog

---

## 🚀 产品发布/更新

### 1. Swiftlet：在 Mac 上运行 80B 版 Qwen（内存 4.3 GB），在 iPhone 上运行 35B 版

Swiftlet 是一个 Swift + Metal 运行时，可在普通 Apple 设备上运行 Qwen3-Next 和 Qwen3.5/3.6 MoE 混合模型，仅将小型稠密核心驻留内存，按需从存储流式加载路由专家权重。

[阅读原文 →](https://github.com/leonickson1/Swiftlet) · 来源：Hacker News 热门

### 2. Reflex 开源 XY：基于 Rust 的超快 Python 绘图库，可保持 1 亿点图表交互流畅

Reflex AI 发布 Apache-2.0 许可的 Python 交互式 2D 绘图库 XY，通过 Rust 原生核心、二进制缓冲传输和 WebGL2 渲染，在 1 万至 1 亿点范围内保持约 0.08 秒的渲染时间。

[阅读原文 →](https://www.marktechpost.com/2026/08/04/reflex-open-sources-xy-a-rust-backed-super-fast-python-charting-library-that-keeps-100-million-point-charts-interactive) · 来源：MarkTechPost

### 3. 面壁智能开源 ForgeStencil：一周自动优化 100+ 工业与科学软件，全程零人工介入

面壁智能联合 OpenBMB 开源全球首个支持 Stencil 自动研究、自动部署的 AI 优化系统 ForgeStencil，由 Kernel Agent 与 App Agent 闭环协作，实现从算子优化到应用集成的全自动流程。

[阅读原文 →](https://mp.weixin.qq.com/s?__biz=Mzg3Mzg2MTg2NQ%3D%3D&mid=2247498861&idx=1&sn=d2d16692dd7eb27f9d466803f25c2b78) · 来源：公众号：面壁智能

### 4. Soup v0.72.4：在4 GB显存笔记本GPU上微调8B模型

Soup 推出 v0.72.4，支持在配备 4 GB 显存的笔记本 GPU 上通过 QLoRA 微调 8B 模型，无需 SSH 或云服务。

[阅读原文 →](https://github.com/MakazhanAlpamys/Soup) · 来源：Hacker News 热门

### 5. OpenRouter 推出 ori CLI：为 Claude Code 等 Harness 提供开箱即用的优化配置

OpenRouter 发布 ori CLI，用户安装并登录后即可获得针对 Claude Code、Codex、OpenCode、Hermes 等 harness 的优化配置，省去手动设置大量环境变量的麻烦。

[阅读原文 →](https://openrouter.ai/blog/announcements/ori-harness) · 来源：OpenRouter：Announcements

### 6. SpecForge v0.3.0 发布：统一解耦与共置投机解码栈，新增开放 SpecBundle 草稿模型

SpecForge v0.3.0 将目标模型推理与草稿模型训练分离，支持 EAGLE3、EAGLE3.1、P-EAGLE、DFlash、Domino、DSpark 等多种投机解码算法，并统一在线、离线与解耦工作流。

[阅读原文 →](https://www.lmsys.org/blog/2026-08-04-specforge-v0-3) · 来源：LMSYS：Blog

### 7. Replit 环境智能：免提示词自动生成设计
...
[阅读原文 →](https://x.com/Replit/status/2084761337570144424) · 来源：X：Replit (@Replit)

### 8. Cloudflare 让智能体通过本地追踪调试 Workers
...
[阅读原文 →](https://blog.cloudflare.com/local-tracing) · 来源：Cloudflare Blog

---

## 🌐 行业动态

### 1. Anthropic 与成立仅数月的云初创公司 Volta 签署 100 亿美元算力协议
...
[阅读原文 →](https://x.com/rohanpaul_ai/status/2084655258102546579) · 来源：X：Rohan Paul (@rohanpaul_ai)

### 2. 工信部发布首部L3/L4自动驾驶系统安全要求强制性国标，2027年7月实施
...
[阅读原文 →](https://www.ithome.com/0/985/665.htm) · 来源：IT之家

### 3. GPT-5.6 Luna降价80%永久生效

有些人显然误解了，但 GPT-5.6 Luna 降价 80% 不是临时噱头，而是永久的。效率提升不会消失。幸运的是。

[阅读原文 →](https://x.com/thsottiaux/status/2084506501834829833) · 来源：X：Tibo (@thsottiaux)

### 4. Mariano-Florentino (Tino) Cuéllar 加入 Anthropic 出任首席全球事务官
...
[阅读原文 →](https://www.anthropic.com/news/tino-cuellar) · 来源：Anthropic：Newsroom

### 5. OpenAI 说明第三方网络安全评估事件并公布新保障措施

OpenAI 就近期第三方网络安全评估事件作出说明，并公布新的保障措施以强化 AI 模型测试与评估流程。相关措施旨在提升模型评估的安全性与可靠性，确保第三方测试在受控环境下进行。

[阅读原文 →](https://openai.com/index/third-party-cyber-evaluations-involving-openai-models) · 来源：OpenAI：官网动态

### 6. AI 领袖提出 SAFE 指南，强化智能体网络安全透明度

Linux 基金会发布共享 AI 事件交换（SAFE）指南征求意见稿，旨在将智能体网络安全事件转化为全生态共享防护。

[阅读原文 →](https://blogs.nvidia.com/blog/open-secure-ai-alliance-contributions) · 来源：NVIDIA Blog

### 7. Google 发布 Gemini 3.6 Flash 等三款新模型及 Gemini Robotics ER 2

Google 在 7 月推出三款新 Gemini 模型——Gemini 3.6 Flash、3.5 Flash-Lite 和 3.5 Flash Cyber，面向生产级 AI 智能体，主打更高 token 效率、更低延迟和更可靠性能。

[阅读原文 →](https://blog.google/innovation-and-ai/technology/ai/google-ai-updates-july-2026) · 来源：Google Blog：AI

---

## 💡 技巧与观点

### 1. 在单颗 AMD MI300X 上运行 DeepSeek V4 Flash
...
[阅读原文 →](https://github.com/ryanzhou/deepseek-v4-flash-mi300x) · 来源：Hacker News 热门
...
[阅读原文 →](https://simonwillison.net/2026/Aug/4/minimax-h3-mlx) · 来源：Simon Willison 博客

### 3. 用 NVIDIA SkillSpector、LangGraph、YARA 规则、SARIF 与 CI 策略门构建高级 AI 技能安全审计流水线

本教程演示如何用 NVIDIA SkillSpector 评估 AI 技能的安全态势，构建包含干净、风险、恶意及 MCP 示例的合成技能市场，并通过 LangGraph 检查流水线扫描每个技能。

[阅读原文 →](https://www.marktechpost.com/2026/08/04/building-an-advanced-ai-skill-security-auditing-pipeline-with-nvidia-skillspector-langgraph-yara-rules-sarif-and-ci-policy-gates) · 来源：MarkTechPost

### 4. Cloudflare 如何用软件工厂将 Astro 的 GitHub issue 数降至零
...
[阅读原文 →](https://blog.cloudflare.com/astro-issue-triage) · 来源：Cloudflare Blog

### 5. GitHub 如何用堆叠式 Pull Request 拆解 AI 生成的巨型代码
...
[阅读原文 →](https://github.blog/engineering/turn-one-giant-ai-generated-pull-request-to-a-reviewable-stack) · 来源：GitHub Blog

### 6. 如何用 LangSmith 评估语音智能体
...
[阅读原文 →](https://www.langchain.com/blog/how-to-evaluate-voice-agents-execution-outcomes-and-experience) · 来源：LangChain：Blog

### 7. 从零开始，教你用Codex搓出属于你自己的第一个硬件
...
[阅读原文 →](https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA%3D%3D&mid=2647684924&idx=1&sn=f9ecf13ac374f13dfa75f98f685a231d) · 来源：公众号：数字生命卡兹克

### 8. 杰文斯悖论还能持续吗：AI 定价分层如何支撑算力需求增长
...
[阅读原文 →](https://www.tomtunguz.com/what-if-gpu-prices-double) · 来源：Tomer Tunguz 博客
