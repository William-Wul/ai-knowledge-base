---
title: 2026-05-25 · AI 日报
description: 2026-05-25 AI 行业精选（数据来自 AIHOT）
date: 2026-05-25
---
...
[阅读原文 →](https://x.com/LumaLabsAI/status/2058672731705503959) · 来源：X：Luma AI (@LumaLabsAI)
...
[阅读原文 →](https://x.com/openclaw/status/2058397616124072274) · 来源：X：OpenClaw (@openclaw)
...
[阅读原文 →](https://x.com/kimmonismus/status/2058584943052161488) · 来源：X：Kim (@kimmonismus)

### 2. DeepSeek将对其旗舰AI模型实施永久性75%折扣

[阅读原文 →](https://www.bloomberg.com/news/articles/2026-05-23/deepseek-to-make-permanent-75-discount-on-flagship-ai-model) · 来源：Hacker News 热门
...
[阅读原文 →](https://x.com/gdb/status/2058598608224858442) · 来源：X：Greg Brockman (@gdb)

### 2. 格雷格·布罗克曼：那段差点让OpenAI覆灭的72小时

[阅读原文 →](https://fs.blog/knowledge-project-podcast/greg-brockman) · 来源：Hacker News 热门

### 3. Claude Code自动模式：多任务并行的关键技巧

人们常问我，用好Claude Code的最大技巧是什么。 如今我的头号技巧是：使用自动模式。 自动模式意味着不再有权限提示。它是实现“多Claude并行”的关键构件：启动一个会话，然后在其运行时，并行处理另一个会话。

[阅读原文 →](https://x.com/bcherny/status/2058519809214607704) · 来源：X：Boris Cherny (@bcherny)

### 4. Pixverse角色设计工作流测试

在Pixverse中进行角色设计工作流测试 使用GPT Image 2.0为Lucas创建视觉形象，使用Seedance 2.0制作动画弹跳表演。 从静态概念图到电影级动态效果。 RT + Follow + Reply = 工作流

[阅读原文 →](https://x.com/PixVerse_/status/2058564994669727803) · 来源：X：PixVerse (@PixVerse_)
