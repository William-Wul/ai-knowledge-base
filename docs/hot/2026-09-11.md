---
title: 2026-09-11 · AI 日报
description: 2026-09-11 AI 行业精选（数据来自 AIHOT）
date: 2026-09-11
---
...
[阅读原文 →](https://api-docs.deepseek.com/zh-cn/updates#%E6%97%B6%E9%97%B4-2026-09-10) · 来源：DeepSeek：API 更新日志
...
[阅读原文 →](https://x.com/WorkBuddy_AI/status/2098076348749324362) · 来源：X：Tencent WorkBuddy (@WorkBuddy_AI)
...
[阅读原文 →](https://x.com/SiliconFlowAI/status/2098054160176545821) · 来源：X：硅基流动 SiliconFlow (@SiliconFlowAI)

### 4. Suno v6 发布，支持图片、视频和语音备忘录生成音乐

Suno 发布 v6 模型，可将图片、视频和语音备忘录转化为音乐，并对已创建的歌曲进行精确修改。同时提供 v6-wild 版本供探索更多可能性，官方附有 2 分钟以内的功能演示视频。

[阅读原文 →](https://x.com/suno/status/2097846245540888664) · 来源：X：Suno (@suno)

---

## 🚀 产品发布/更新

### 1. OpenAI 发布 Agents API 公测版

OpenAI 推出 Agents API 公开测试版，将驱动 Codex 的 harness 与基础设施通过单次 API 调用开放给开发者，托管在云端。

[阅读原文 →](https://openai.com/index/introducing-the-agents-api) · 来源：OpenAI：官网动态

### 2. Cursor 推出 Projects：协调者智能体管理数千个子智能体处理大型开发任务

Cursor 发布 Projects（beta），让用户通过协调者智能体处理功能开发、迁移和持续性维护等大型工作，协调者本身不写代码，而是调度数千个子智能体并行执行。

[阅读原文 →](https://cursor.com/blog/projects) · 来源：Cursor Blog

### 3. OpenAI 在 API 中推出全双工语音模型 GPT-Live-1

OpenAI 在 API 中发布语音模型 GPT-Live-1，可同时听和说，支持将推理和工具调用委派给 GPT-6 Astra 等后端模型，前端语音层定价为每分钟 $0.05。

[阅读原文 →](https://openai.com/index/introducing-gpt-live-1-in-the-api) · 来源：OpenAI：官网动态
...
[阅读原文 →](https://x.com/GoogleAI/status/2098072879480947085) · 来源：X：Google AI (@GoogleAI)

### 5. Hugging Face 用 Gradio Workflow 重建 Workflow1111，复刻 AUTOMATIC1111 主要功能
...
[阅读原文 →](https://huggingface.co/blog/gradio-workflow-1111) · 来源：Hugging Face：Blog

### 6. OpenAI 在 ChatGPT Work 中推出 Data agent

OpenAI 在 ChatGPT Work 中推出新的 Data agent，用户用自然语言即可连接公司数据、分析变化并生成可分享的交互式仪表盘。

[阅读原文 →](https://openai.com/index/put-data-to-work) · 来源：OpenAI：官网动态
...
[阅读原文 →](https://shopify.engineering/back-to-native) · 来源：Hacker News 热门

### 2. Anthropic 报告指控阿里、月之暗面与 DeepSeek 对 Claude 发起蒸馏攻击

Anthropic 发布报告，指控多家中国 AI 公司对 Claude 持续发起蒸馏攻击，累计发现近 2 亿次相关交互，涉及五个活动。

[阅读原文 →](https://techcrunch.com/2026/09/10/anthropic-details-distillation-campaigns-from-alibaba-moonshot-ai-and-deepseek) · 来源：TechCrunch：AI
...
[阅读原文 →](https://www.anthropic.com/research/intelligence-targeting-conventional-weapons-capabilities) · 来源：Anthropic：Research
...
[阅读原文 →](https://the-decoder.com/swarmchasers-hunt-rogue-agents-anthropic-investigates-itself-and-the-trail-they-both-follow-is-going-dark) · 来源：The Decoder：AI News
...
[阅读原文 →](https://cognition.com/blog/factoring-rsa-260) · 来源：Hacker News 热门

### 3. 27岁前Anthropic研究员Jacob Coxon辞职警示AI灭绝风险，作者重读Tim Urban《人工智能革命》谈文明赌局
...
[阅读原文 →](https://mp.weixin.qq.com/s?__biz=MzIyMzA5NjEyMA%3D%3D&mid=2647686114&idx=1&sn=ef25c9da794a29795c3d7ca0637efafb) · 来源：公众号：数字生命卡兹克
