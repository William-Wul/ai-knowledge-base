---
title: 2026-06-02 · AI 日报
description: 2026-06-02 AI 行业精选（数据来自 AIHOT）
date: 2026-06-02
---
...
[阅读原文 →](https://www.minimax.io/blog/minimax-m3) · 来源：MiniMax：Blog

### 2. xAI发布Composer 2.5

xAI的最新编程模型Composer 2.5现已在Grok Build中可用，用户可通过`/models`菜单选择使用。这是一款快速、先进的模型，擅长处理长时间运行的任务和复杂指令。该模型面向SuperGrok和X Premium+用户开放。

[阅读原文 →](https://x.ai/news/composer-2-5) · 来源：xAI：News

### 3. Qwen3.7-Plus：多模态智能体智能

Qwen Studio 提供涵盖聊天机器人、图像与视频理解、图像生成、文档处理、网页搜索集成、工具使用及制品生成的全面功能。

[阅读原文 →](https://qwen.ai/blog?id=qwen3.7-plus) · 来源：Qwen：Blog Retrieval

### 4. 使用NVIDIA Cosmos 3开发物理AI推理、世界与行动模型

NVIDIA Cosmos 3是一款面向物理AI的前沿基础模型。它能够帮助机器人、自动驾驶车辆和智能空间理解真实世界、预测事件发展并生成适应特定环境与任务的行动。该模型融合了物理推理、世界理解与行动生成能力。

[阅读原文 →](https://developer.nvidia.com/blog/develop-physical-ai-reasoning-world-and-action-models-with-nvidia-cosmos-3) · 来源：NVIDIA Technical Blog

### 5. SenseNova新模型解决AI图表生成难题
...
[阅读原文 →](https://x.com/SenseTime_AI/status/2061465029959209106) · 来源：X：商汤 SenseTime (@SenseTime_AI)

### 6. 介绍 Mellum2：JetBrains 推出的 12B 混合专家模型

JetBrains 在 Hugging Face 发布博客，介绍其新发布的 Mellum2 模型。该模型采用混合专家架构，参数规模为 12B。

[阅读原文 →](https://huggingface.co/blog/JetBrains/mellum2-launch) · 来源：Hugging Face：Blog

### 7. Nemotron 3 Ultra 本周即将发布

Nemotron 3 Ultra 本周即将发布。 ⌛️

[阅读原文 →](https://x.com/NVIDIAAI/status/2061305524700758050) · 来源：X：NVIDIA AI (@NVIDIAAI)

---

## 🚀 产品发布/更新

### 1. OpenBMB发布UltraData两大开源数据集，登顶HuggingFace趋势榜
...
[阅读原文 →](https://x.com/OpenBMB/status/2061432928492810535) · 来源：X：面壁智能 OpenBMB (@OpenBMB)
...
[阅读原文 →](https://x.com/OpenRouter/status/2061476882470580329) · 来源：X：OpenRouter (@OpenRouter)

### 3. OpenAI前沿模型与Codex现可在AWS上使用

OpenAI的前沿模型与Codex现已在AWS上全面可用。企业客户可通过其现有的AWS环境、控制与采购流程来使用OpenAI的AI技术，从而加速从评估到生产部署的过程。

[阅读原文 →](https://openai.com/index/openai-frontier-models-and-codex-are-now-available-on-aws) · 来源：OpenAI：官网动态
...
[阅读原文 →](https://x.com/Replit/status/2061534759520760112) · 来源：X：Replit (@Replit)

### 5. 腾讯混元发布智能体长期记忆插件Hy-Memory
...
[阅读原文 →](https://x.com/TencentHunyuan/status/2061372535267357029) · 来源：X：腾讯混元 (@TencentHunyuan)
...
[阅读原文 →](https://blogs.nvidia.com/blog/factory-operations-fox-blueprint-ai-brain) · 来源：NVIDIA Blog：Agentic AI

### 7. ChatGPT 新增长文编辑与保存功能

长文写作需要更多空间。 现在你可以在全屏模式下编辑更长的文章，并将其保存到你的资料库中，以便稍后继续。

[阅读原文 →](https://x.com/ChatGPTapp/status/2061571468992126982) · 来源：X：ChatGPT (@ChatGPTapp)

### 8. Perplexity发布Search as Code搜索架构
...
[阅读原文 →](https://x.com/perplexity_ai/status/2061506359326384319) · 来源：X：Perplexity (@perplexity_ai)
...
[阅读原文 →](https://www.anthropic.com/news/confidential-draft-s1-sec) · 来源：Anthropic：Newsroom
...
[阅读原文 →](https://www.ithome.com/0/958/444.htm) · 来源：IT之家

### 3. Alphabet将通过发行股票筹集800亿美元用于AI支出计划

Alphabet正在通过发行股票等方式筹集800亿美元资金，其中包括与Berkshire Hathaway的投资协议，以资助其雄心勃勃的AI支出计划。

[阅读原文 →](https://www.bloomberg.com/news/articles/2026-06-01/alphabet-to-raise-80-billion-in-equity-capital-for-ai-spending) · 来源：Bloomberg：Technology

### 4. 佛罗里达州起诉OpenAI与Sam Altman：涉多起ChatGPT相关谋杀案

佛罗里达州对OpenAI及其CEO Sam Altman提起诉讼。该州总检察长指控Altman对人命“完全漠视”，案件与多起涉及ChatGPT的谋杀事件相关。

[阅读原文 →](https://arstechnica.com/tech-policy/2026/06/florida-sues-openai-sam-altman-after-multiple-chatgpt-linked-murders) · 来源：Ars Technica：AI
...
[阅读原文 →](https://www.ithome.com/0/958/410.htm) · 来源：IT之家

### 6. 英伟达和台积电将 AI 引入晶圆厂，推动半导体设计与制造发展

[阅读原文 →](https://www.ithome.com/0/958/109.htm) · 来源：IT之家

### 7. OpenAI在密歇根州启动Stargate 1GW数据中心建设

OpenAI在密歇根州启动了名为Stargate的1GW数据中心项目。作为AI基础设施建设的一部分，该项目旨在扩大人工智能技术的可及性、为当地创造就业机会并支持社区发展。

[阅读原文 →](https://openai.com/index/stargate-michigan-data-center) · 来源：OpenAI：官网动态

### 8. Meta的AI被利用来劫持Instagram账号

Meta的AI聊天机器人被发现存在安全漏洞，黑客可以通过请求该AI关联一个新的电子邮件地址，从而接管目标用户的Instagram账号。该漏洞利用了AI智能体直接执行账户管理操作的能力。

[阅读原文 →](https://www.theverge.com/tech/941179/meta-instagram-ai-support-chatbot-exploit-hacked) · 来源：The Verge：订阅版科技
...
[阅读原文 →](https://x.com/vista8/status/2061443708374208769) · 来源：X：Vista (@vista8)

### 2. 使用Claude Opus 4.8将书籍转化为AI技能的教程
...
[阅读原文 →](https://x.com/AYi_AInotes/status/2061419197154857286) · 来源：X：阿易 AI Notes (@AYi_AInotes)

### 3. Sam Altman强调AI发展应以人为本
...
[阅读原文 →](https://x.com/rohanpaul_ai/status/2061586179292831774) · 来源：X：Rohan Paul (@rohanpaul_ai)
...
[阅读原文 →](https://x.com/OpenRouter/status/2061452942385783050) · 来源：X：OpenRouter (@OpenRouter)

### 5. Gemini Omni支持创建个人数字分身

轻松将自己添加到Gemini的视频创作中。 以下是如何使用Gemini Omni创建一个外观和声音都像你的数字分身。🧵

[阅读原文 →](https://x.com/GeminiApp/status/2061480944905982276) · 来源：X：Gemini (@GeminiApp)

### 6. Google AI 展示并行子智能体自动整理文件

从杂乱到清晰。观看 @Antigravity 中的并行子智能体对数百个营销资产进行分类和重命名，消除手动文件管理。

[阅读原文 →](https://x.com/googleaidevs/status/2061515177166844317) · 来源：X：Google AI for Developers (@googleaidevs)

### 7. 开源与闭源模型在不同的增长曲线上

当模型智能的微小提升能直接转化为实际价值时，开源与闭源模型正沿着不同的增长路径发展。闭源模型通过在特定场景下提供更高的边际智能来创造价值，而开源模型则在其他维度寻找增长点，两者形成了差异化的竞争格局。

[阅读原文 →](https://www.interconnects.ai/p/open-and-closed-models-are-on-different) · 来源：Nathan Lambert：Interconnects

### 8. 微软研究聚焦：智能体评估与价值对齐

大规模评估智能体行为，论证代码库优于文档，并邀请全球研究人员共同解决价值对齐问题。深入了解最新研究焦点。

[阅读原文 →](https://x.com/MSFTResearch/status/2061440352859361521) · 来源：X：Microsoft Research (@MSFTResearch)
