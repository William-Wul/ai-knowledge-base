---
title: 2026-05-30 · AI 日报
description: 2026-05-30 AI 行业精选（数据来自 AIHOT）
date: 2026-05-30
---
...
[阅读原文 →](https://x.com/gdb/status/2060452095279415725) · 来源：X：Greg Brockman (@gdb)
...
[阅读原文 →](https://www.ithome.com/0/957/282.htm) · 来源：IT之家

### 3. Qwen-VLA：从理解世界到在其中行动

Qwen Studio提供全面功能，涵盖聊天机器人、图像与视频理解、图像生成、文档处理、网络搜索集成、工具利用及Artifacts。

[阅读原文 →](https://qwen.ai/blog?id=qwenvla) · 来源：Qwen：Blog Retrieval

---

## 🚀 产品发布/更新

### 1. Codex可自主管理对话线程与并行任务

Codex用于管理Codex界面： [引用 @guinnesschen]：如果你厌倦了管理Codex对话线程，就让Codex自己管理自己吧！Codex现在可以创建对话线程、搜索它们、整理它们、固定重要的线程，并为并行任务启动工作树。

[阅读原文 →](https://x.com/gdb/status/2060486309886443787) · 来源：X：Greg Brockman (@gdb)

### 2. Gemini Omni可将草图变为现实

Gemini Omni甚至能将简单的草图变为新的现实。 在Gemini应用中亲自尝试。上传一段有人画圆的视频，然后输入这个提示词：当我画完这个圆时，它变成了___。

[阅读原文 →](https://x.com/GeminiApp/status/2060435981946503243) · 来源：X：Gemini (@GeminiApp)

### 3. Codex现已支持Windows端计算机使用功能
...
[阅读原文 →](https://x.com/OpenAI/status/2060428604727771421) · 来源：X：OpenAI (@OpenAI)

### 4. Guardrails：保护你的智能体、数据与成本

Guardrails 是一套可配置的安全与治理工具，提供预算执行、零数据保留、模型与提供商限制、提示词注入防御及数据丢失预防等功能，旨在保护智能体（Agents）、数据与控制成本。

[阅读原文 →](https://openrouter.ai/announcements/guardrails) · 来源：OpenRouter：Announcements

### 5. ComfyUI现已支持OpenRouter模型直接调用
...
[阅读原文 →](https://x.com/OpenRouter/status/2060511136932315259) · 来源：X：OpenRouter (@OpenRouter)

### 6. Runway API持续扩展模型与端点支持
...
[阅读原文 →](https://x.com/runwayml/status/2060453805519765548) · 来源：X：Runway (@runwayml)

### 7. OpenRouter支持模型生成文件补丁
...
[阅读原文 →](https://x.com/OpenRouter/status/2060395056196936054) · 来源：X：OpenRouter (@OpenRouter)

### 8. ChatGPT对话目录功能现已上线

对于每个始于“就问一件事”却演变成完整长篇的ChatGPT对话：目录功能现已推出。 适用于包含5条以上回复的对话。

[阅读原文 →](https://x.com/ChatGPTapp/status/2060467129066070182) · 来源：X：ChatGPT (@ChatGPTapp)

---

## 🌐 行业动态

### 1. Anthropic估值9650亿美元超越OpenAI

Anthropic在最新融资轮中筹集了650亿美元，融资后公司估值达到9650亿美元，首次超越竞争对手OpenAI的估值水平。

[阅读原文 →](https://www.bloomberg.com/news/videos/2026-05-29/anthropic-valuation-of-965-billion-passes-openai-video) · 来源：Bloomberg：Technology

### 2. 中央网信办等四部门：提升全民人工智能素养，加快人才培育、深化普及应用
...
[阅读原文 →](https://www.ithome.com/0/957/319.htm) · 来源：IT之家

### 3. 波士顿儿童医院利用AI解锁新诊断

波士顿儿童医院通过部署OpenAI技术，用于改善患者护理并减轻运营负担，成功帮助诊断了超过40种罕见病病例。

[阅读原文 →](https://openai.com/index/boston-childrens-hospital) · 来源：OpenAI：官网动态
...
[阅读原文 →](https://x.com/drfeifei/status/2060404846734512205) · 来源：X：Fei-Fei Li (@drfeifei, World Labs)
...
[阅读原文 →](https://x.com/hongming731/status/2060487110906527820) · 来源：X：洪明 (@hongming731)
...
[阅读原文 →](https://x.com/rohanpaul_ai/status/2060409504693645440) · 来源：X：Rohan Paul (@rohanpaul_ai)

### 3. Adam’s Law：用高频词写Prompt效果更好
...
[阅读原文 →](https://x.com/berryxia/status/2060212428584202428) · 来源：X：Berry Xia (@berryxia)
...
[阅读原文 →](https://x.com/shao__meng/status/2060167182777249886) · 来源：X：邵猛 (@shao__meng)
...
[阅读原文 →](https://buildingbetter.tech/p/i-read-the-claude-code-source-code) · 来源：Hacker News 热门

### 6. 当公司过于"AI上瘾"时会发生什么？

Box创始人Aaron Levie指出，决定用AI替代员工的人往往最不了解工作的实际内容，他将此称为“AI psychosis”。ClickUp近期为部署AI智能体裁员22%即是一例。2026年的科技行业裁员规模已接近2025年全年。

[阅读原文 →](https://techcrunch.com/video/what-happens-when-companies-become-too-ai-pilled) · 来源：TechCrunch：AI
...
[阅读原文 →](https://www.ithome.com/0/956/864.htm) · 来源：IT之家

### 8. Cognition的Scott Wu表示：AI编程智能体不应取代人类

Cognition公司开发了Devvin，这是一个号称首个且最成功的AI编程智能体。其著名程序员创始人Scott Wu明确表示，该智能体并非旨在取代人类程序员。

[阅读原文 →](https://techcrunch.com/2026/05/29/cognitions-scott-wu-says-ai-coding-agents-shouldnt-replace-humans) · 来源：TechCrunch：AI
