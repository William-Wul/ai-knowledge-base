---
title: "身心健康品牌首页"
description: "整体疗愈品牌 Vibrant Wellness 的单页 首屏，React + TypeScript + Tailwind。"
...
import item from '../.vitepress/data/cases-generated/mind-body-healing.json'
</script>

# 身心健康品牌首页

整体疗愈品牌 Vibrant Wellness 的单页 首屏，React + TypeScript + Tailwind。
...
- 作者：MotionSites
- 案例收录：[Goodcase](https://goodcase.ai/cases/mind-body-healing) · [原始出处](https://motionsites.ai/?prompt=mind-body-healing)
- 整理日期：2026-09-23
