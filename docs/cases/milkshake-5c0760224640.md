---
title: "奶昔配料的分层信息图"
description: "一款用于饮品的爆炸视图信息图提示词，展示了具有专业影棚灯光和质感的层叠配料。"
...
import item from '../.vitepress/data/cases-generated/milkshake-5c0760224640.json'
</script>

# 奶昔配料的分层信息图

一款用于饮品的爆炸视图信息图提示词，展示了具有专业影棚灯光和质感的层叠配料。
...
- 作者：@Strength04\_X
- 案例收录：[Goodcase](https://goodcase.ai/cases/milkshake-5c0760224640) · [原始出处](https://x.com/Strength04_X/status/2090665058980462697)
- 整理日期：2026-09-23
