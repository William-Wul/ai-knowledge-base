---
title: "数字员工平台介绍页"
description: "数字员工平台 Axon 的单页 首屏，把部署数字工人这个抽象概念做成可视的首屏。"
...
- 作者：MotionSites
- 案例收录：[Goodcase](https://goodcase.ai/cases/ai-workflow-agents) · [原始出处](https://motionsites.ai/?prompt=ai-workflow-agents)
- 整理日期：2026-09-23
