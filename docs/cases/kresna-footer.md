---
title: "销售平台的动态页脚"
description: "将品牌信息、链接和动效收进独立页脚，适合嵌入已有网页。"
...
import item from '../.vitepress/data/cases-generated/kresna-footer.json'
</script>

# 销售平台的动态页脚

将品牌信息、链接和动效收进独立页脚，适合嵌入已有网页。
...
- 作者：MotionSites
- 案例收录：[Goodcase](https://goodcase.ai/cases/kresna-footer) · [原始出处](https://motionsites.ai/?prompt=kresna-footer)
- 整理日期：2026-09-23
