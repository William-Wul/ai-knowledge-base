---
title: "设计课程的全屏展示页"
description: "用全屏视频背景、课程标题和按钮，组织设计教育平台的第一屏。"
...
import item from '../.vitepress/data/cases-generated/designpro-academy.json'
</script>

# 设计课程的全屏展示页

用全屏视频背景、课程标题和按钮，组织设计教育平台的第一屏。
...
- 作者：MotionSites
- 案例收录：[Goodcase](https://goodcase.ai/cases/designpro-academy) · [原始出处](https://motionsites.ai/?prompt=designpro-hero)
- 整理日期：2026-09-23
