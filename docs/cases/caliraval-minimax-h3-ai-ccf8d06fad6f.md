---
title: "参考图驱动的产品时尚短片"
description: "以参考图锁定产品和人物，用时尚广告的镜头组织一段短片。"
...
import item from '../.vitepress/data/cases-generated/caliraval-minimax-h3-ai-ccf8d06fad6f.json'
</script>

# 参考图驱动的产品时尚短片

以参考图锁定产品和人物，用时尚广告的镜头组织一段短片。
...
- 作者：@CaliraVal
- 案例收录：[Goodcase](https://goodcase.ai/cases/caliraval-minimax-h3-ai-ccf8d06fad6f) · [原始出处](https://x.com/CaliraVal/status/2089221706435248245)
- 整理日期：2026-09-23
