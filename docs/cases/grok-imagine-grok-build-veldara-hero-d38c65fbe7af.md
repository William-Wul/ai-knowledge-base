---
title: "自然风格的品牌首页"
description: "@viktoroddy 使用 Grok Imagine · Grok Build完成的网页案例，包含公开结果、完整 提示词 与原始来源。"
...
import item from '../.vitepress/data/cases-generated/grok-imagine-grok-build-veldara-hero-d38c65fbe7af.json'
</script>

# 自然风格的品牌首页

@viktoroddy 使用 Grok Imagine · Grok Build完成的网页案例，包含公开结果、完整 提示词 与原始来源。
...
- 作者：@viktoroddy
- 案例收录：[Goodcase](https://goodcase.ai/cases/grok-imagine-grok-build-veldara-hero-d38c65fbe7af) · [原始出处](https://x.com/viktoroddy/status/2067218410350797295)
- 整理日期：2026-09-23
